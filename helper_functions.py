...
def num_tokens_from_string(string: str, encoding_name: str) -> int:
    ...
    """
     ...
     encoding = tiktoken.encoding_name_for_model(encoding_name)
...
def replace_double_lines_with_one_lines(text):
    """
...
def split_into_chapters(book_path):
    ...
    with open(book_path, 'rb') as pdf_file:
        pdf_render = PyPDF2.PdfReader(pdf_file)
        documents = pdf_render.pages
